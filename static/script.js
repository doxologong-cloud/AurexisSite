...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const modules = [
        { id: 'module-music', html: '<div class="discord-embed"><div class="discord-embed-title">?? ������ ������</div><div>Cyberpunk Mix 2026 - Synthwave Radio</div></div>' },
        { id: 'module-economy', html: '?? <strong>@user</strong>, ��� ������ �������� �� 500 �����! ������� ������: 1500.' },
        { id: 'module-moderation', html: '?? <strong>@troll</strong> ��� ������������ ����������� <strong>@admin</strong>. �������: ����.' },
        { id: 'module-ai', html: '?? <em>��������� �����...</em><br>������������� ��������� AUREXIS FLORA ����� � ������. ������� ��� ����� ������.' }
    ];
